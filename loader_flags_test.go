...
func TestPrepareFlag_Primitives(t *testing.T) {
	cases := []struct {
		...
		{name: "bool-short", item: true, tags: reflect.StructTag(`flag:"bool-short,short:s"`)},
		{name: "string", item: "foo", tags: reflect.StructTag(`flag:"string"`)},
		{name: "string-short", item: "foo", tags: reflect.StructTag(`flag:"string-short,short:s"`)},
		{name: "int", item: 123, tags: reflect.StructTag(`flag:"int"`)},
		{name: "int-short", item: 321, tags: reflect.StructTag(`flag:"int-short,short:s"`)},
		{name: "int32", item: int32(123), tags: reflect.StructTag(`flag:"int32"`)},
		{name: "int32-short", item: int32(123), tags: reflect.StructTag(`flag:"int32-short,short:s"`)},
		{name: "int64", item: int64(123), tags: reflect.StructTag(`flag:"int64"`)},
		{name: "int64-short", item: int64(123), tags: reflect.StructTag(`flag:"int64-short,short:s"`)},
		{name: "uint", item: uint(123), tags: reflect.StructTag(`flag:"uint"`)},
		{name: "uint-short", item: uint(123), tags: reflect.StructTag(`flag:"uint-short,short:s"`)},
		{name: "uint32", item: uint32(123), tags: reflect.StructTag(`flag:"uint32"`)},
		{name: "uint32-short", item: uint32(123), tags: reflect.StructTag(`flag:"uint32-short,short:s"`)},
		{name: "uint64", item: uint64(123), tags: reflect.StructTag(`flag:"uint64"`)},
		{name: "uint64-short", item: uint64(123), tags: reflect.StructTag(`flag:"uint64-short,short:s"`)},
		{name: "float32", item: float32(123), tags: reflect.StructTag(`flag:"float32"`)},
		{name: "float32-short", item: float32(123), tags: reflect.StructTag(`flag:"float32-short,short:s"`)},
		{name: "float64", item: float64(123), tags: reflect.StructTag(`flag:"float64"`)},
		{name: "float64-short", item: float64(123), tags: reflect.StructTag(`flag:"float64-short,short:s"`)},
	...
	for _, tt := range cases {
		t.Run(tt.name, func(t *testing.T) {
			...
			if opts.FlagShortName != "" {
				args = append(args, "-"+opts.FlagShortName, flagValue)
			} else {
				args = append(args, "--"+opts.FlagFullName, flagValue)
			}
...
func TestPrepareFlag_Slices(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "slice-int-short", item: []int{3, 4, 5}, tags: reflect.StructTag(`flag:"slice-int,short:s"`)},
		{name: "slice-int32", item: []int32{5, 6, 7}, tags: reflect.StructTag(`flag:"slice-int32"`)},
		{name: "slice-int32-short", item: []int32{5, 6, 7}, tags: reflect.StructTag(`flag:"slice-int32,short:s"`)},
	...
	t.Run("slice-bytes", func(t *testing.T) {
		...
		for _, base := range []string{"base:hex", "base:b64"} {
			t.Run(base, func(t *testing.T) {
				for _, flag := range []string{"flag", "short"} {
					t.Run(flag, func(t *testing.T) {
						...
						var args []string
						if opts.FlagShortName != "" {
							args = append(args, "-"+opts.FlagShortName, encoders[opts.FlagEncodeBase](item))
						} else {
							args = append(args, "--"+opts.FlagFullName, encoders[opts.FlagEncodeBase](item))
						}
